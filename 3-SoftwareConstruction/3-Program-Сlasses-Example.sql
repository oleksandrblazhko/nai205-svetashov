-- DROP TYPE User_Info_Class FORCE;
    ...
    -- Setter в программном классе User для двух атрибутов
	MEMBER PROCEDURE set_e_mail_phone_number(p_id_user NUMBER,p_e_mail VARCHAR, p_phone_number VARCHAR),
    -- Getter в программном классе User для получения атрибута name
...
--Создаю Product_list - список типа Product
